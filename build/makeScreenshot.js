 ...
 */
var modifyElements = function modifyElements(elements, style, value) {
...
module.exports = function (done) {
     ...
     */
    q.all([modifyElements.call(that, hiddenElements, 'visibility', 'hidden'), modifyElements.call(that, removeElements, 'display', 'none')]).then(function () {
        /**
         ...
         */
        return q.all([modifyElements.call(that, hiddenElements, 'visibility', ''), modifyElements.call(that, removeElements, 'display', '')]);
    }).then(function () {
        done();
    }).done();
};
